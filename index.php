...
?>
    <!--======================================
        START HERO AREA
======================================-->
    <section class="header hero-area bg-dark overflow-hidden section-padding">
                            ...
                            <div class="hero-content">
                                ...
                                <p class="lh-26 text-white">This is just a simple text made for this unique and awesome
                                    ...
                                    <form action="posts.php" method="get" class="row mr-4 mt-4">
                                        ...
                                        <div class="col-sm-12 col-md-12 form-group mb-md-0 mb-4">
                                            <input class="form-control form--control " type="text"
                                            name="search" placeholder="Type your search words...">
                                            <button class="form-btn" style="padding: 14px 27px;" type="submit"><i class="la la-search"></i></button>
                                        </div>
            ...
            <div class="row">
                <div class="col-lg-6 responsive-column-half">
                    <div class="media media-card align-items-center">
                        ...
                        <img src="https://img.icons8.com/color/64/000000/customer-insight.png"/>
                        </div>
                        <div class="media-body">
                                <h3 class="fs-21 text-gray">Our goal for consumers</h3>
                            <p class="pb-3 fs-18">Find the best answer to your technical question, <br> help others
                                answer theirs</p>
                        </div>
                    </div>
                </div><!-- end col-lg-6 -->
                <div class="col-lg-6 responsive-column-half">
                    <div class="media media-card align-items-center">
                        <div class="icon-element icon-element-lg mr-4 shadow-sm rounded-rounded border border-gray">
                            <img src="https://img.icons8.com/cotton/64/000000/shop--v4.png"/>
                        </div>
                        <div class="media-body">
                           <h3 class="fs-21 text-gray">Our goal for brands</h3>
                    ...
                    <div class="card card-item hover-y text-center">
                        <div class="card-body">
                            <svg width="70" viewbox="0 0 128 128" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <g fill="#2f3a5a">
                                    <path
                                        d="m56.906 96.09a20.952 20.952 0 0 1 -18.536-11.255 25.9 25.9 0 1 1 -21.028-47.135c-.027-.467-.039-.909-.039-1.336a25.887 25.887 0 0 1 44.344-18.156 23.577 23.577 0 0 1 30.992 6.874 19.222 19.222 0 0 1 8.061-1.749 19.47 19.47 0 0 1 18.238 26.267 19.459 19.459 0 0 1 -19.172 33.814 19.456 19.456 0 0 1 -25.539 3.471 20.733 20.733 0 0 1 -17.321 9.205zm-18.106-13.657a1 1 0 0 1 .91.585 18.9 18.9 0 0 0 33.386 1.926 1 1 0 0 1 1.457-.282 17.453 17.453 0 0 0 24.18-3.135 1 1 0 0 1 1.274-.252 17.46 17.46 0 0 0 17.193-30.393 1 1 0 0 1 -.423-1.259 17.461 17.461 0 0 0 -24.024-22.374 1 1 0 0 1 -1.294-.345 21.575 21.575 0 0 0 -29.459-6.578 1 1 0 0 1 -1.262-.171 23.887 23.887 0 0 0 -41.438 16.209c0 .6.028 1.244.087 1.959a1 1 0 0 1 -.7 1.035 23.894 23.894 0 1 0 19.585 43.22 1 1 0 0 1 .528-.145z">
                                    </path>
                                    <path
                                        d="m25.9 88.034a25.921 25.921 0 0 1 -25.9-25.891 1 1 0 0 1 2 0 23.895 23.895 0 0 0 44.876 11.43 1 1 0 0 1 1.756.958 25.9 25.9 0 0 1 -22.732 13.503z">
                                    </path>
                                    <path
                                        d="m95.953 39.672a1 1 0 0 1 -1-1 21.584 21.584 0 0 0 -39.182-12.5 1 1 0 0 1 -1.63-1.159 23.584 23.584 0 0 1 42.812 13.659 1 1 0 0 1 -1 1z">
                                    </path>
                                    <path
                                        d="m113.436 57.16a1 1 0 0 1 -.69-1.724 17.461 17.461 0 0 0 -12.046-30.1 1 1 0 0 1 0-2 19.46 19.46 0 0 1 13.425 33.55.992.992 0 0 1 -.689.274z">
                                    </path>
                                </g>
                                <path
                                ...
                                <path
                                    ...
                                    fill="#2f3a5a"></path>
                                <rect fill="#fac77c" height="43.593" rx="8.123" width="53.599" x="37.2" y="72.934">
                                </rect>
                                <path
...
================================= -->
    <section class="info-area section--padding">
        <div class="container">
            <div class="text-center">
                <h2 class="section-title lh-50 pb-35px">Capture your company’s knowledge and context in a
            ...
            <div class="row pt-60px align-items-center">
                ...
                <div class="col responsive-column-half card card-item case-card text-center">
                    <div class="card-body">
                        <svg aria-hidden="true" width="96" height="96" viewbox="0 0 96 96">
                            <path
                                d="M86 26.5a6.5 6.5 0 100-13 6.5 6.5 0 000 13zm-52 25a6.5 6.5 0 100-13 6.5 6.5 0 000 13zm-15 40a6.5 6.5 0 100-13 6.5 6.5 0 000 13zM72.5 60a6.5 6.5 0 11-13 0 6.5 6.5 0 0113 0z"
                                opacity=".2"></path>
                            <path
                                d="M75 17a8 8 0 116.49 7.86L68.04 50.79A7.98 7.98 0 0163 65a8 8 0 01-7.85-9.55l-17-9.84a8 8 0 01-8.56 4.27L20.21 75.2a8 8 0 11-2.8-1.08l9.38-25.32a8 8 0 1112.19-6.18l17.3 10.02a8 8 0 019.12-3.27l13.29-25.63A8 8 0 0175 17zm8-5a5 5 0 100 10 5 5 0 000-10zM31 37a5 5 0 100 10 5 5 0 000-10zM16 77a5 5 0 100 10 5 5 0 000-10zm42-20a5 5 0 1010 0 5 5 0 00-10 0z">
                            </path>
                        </svg>
                ...
                <div class="col responsive-column-half card card-item case-card text-center">
                    <div class="card-body">
                        <svg aria-hidden="true" width="96" height="96" viewbox="0 0 96 96">
                            <path opacity=".2"
                                d="M36 47.5a9.48 9.48 0 01-3.67 7.5h5.76a1 1 0 01.7.29l1.39 1.36A9.5 9.5 0 0157.87 54h7.7a9.5 9.5 0 1113.86 0H83a4 4 0 014 4v23a2 2 0 01-2 2H64v10a1 1 0 01-1 1H36a1 1 0 01-1-1V83H16a1 1 0 01-1-1V59a4 4 0 014-4h1.67a9.48 9.48 0 015.83-17 9.5 9.5 0 019.5 9.5z">
                            </path>
                            <path
                                d="M13 44.5A11 11 0 1130.98 53h.52a1.5 1.5 0 010 3H15.54C13.5 56 12 57.54 12 59.21V78h4.38a1.5 1.5 0 01-.38-1V63a1.5 1.5 0 013 0v14c0 .38-.14.73-.38 1h9.06a1.5 1.5 0 010 3H10.5A1.5 1.5 0 019 79.5V59.21c0-3.5 3.03-6.21 6.54-6.21h1.48A10.98 10.98 0 0113 44.5zm11-8a8 8 0 100 16 8 8 0 000-16zm23 8A11 11 0 0040.02 64h-1.33C35.12 64 32 66.73 32 70.3v20.2c0 .83.67 1.5 1.5 1.5h27c.83 0 1.5-.67 1.5-1.5V70.3c0-3.57-3.12-6.3-6.7-6.3h-1.32A11 11 0 0047 44.5zm-8 11a8 8 0 1116 0 8 8 0 01-16 0zm-4 14.8c0-1.7 1.55-3.3 3.7-3.3h16.6c2.15 0 3.7 1.6 3.7 3.3V89h-4V75a1.5 1.5 0 00-3 0v14H42V75a1.5 1.5 0 00-3 0v14h-4V70.3zm35-36.8A11 11 0 0176.98 53h1.7A6.28 6.28 0 0185 59.21V79.5c0 .83-.67 1.5-1.5 1.5H66.32a1.5 1.5 0 010-3h8.06a1.5 1.5 0 01-.38-1V63a1.5 1.5 0 013 0v14c0 .38-.14.73-.38 1H82V59.21A3.28 3.28 0 0078.68 56H62.5a1.5 1.5 0 010-3h.52A11 11 0 0170 33.5zm8 11a8 8 0 10-16 0 8 8 0 0016 0z">
                            </path>
                            <path
                                d="M12.5 11a1.5 1.5 0 000 3h13a1.5 1.5 0 000-3h-13zM11 17.5c0-.83.67-1.5 1.5-1.5h9a1.5 1.5 0 010 3h-9a1.5 1.5 0 01-1.5-1.5zm-5-10C6 6.67 6.67 6 7.5 6h25c.83 0 1.5.67 1.5 1.5v15c0 .83-.67 1.5-1.5 1.5H29v6a1.5 1.5 0 01-2.4 1.2L17 24H7.5A1.5 1.5 0 016 22.5v-15zM9 9v12h8.5c.32 0 .64.1.9.3L26 27v-6h5V9H9zm60.5 3a1.5 1.5 0 000 3h13a1.5 1.5 0 000-3h-13zM68 18.5c0-.83.67-1.5 1.5-1.5h8a1.5 1.5 0 010 3h-8a1.5 1.5 0 01-1.5-1.5zM87.5 7c.83 0 1.5.67 1.5 1.5v16c0 .83-.67 1.5-1.5 1.5H76.42l-7.15 4.29A1.5 1.5 0 0167 29v-3h-2.5a1.5 1.5 0 01-1.5-1.5v-16c0-.83.67-1.5 1.5-1.5h23zM86 23V10H66v13h4v3.35l5.23-3.14c.23-.14.5-.21.77-.21h10zm-42.5 4a1.5 1.5 0 000 3h9a1.5 1.5 0 000-3h-9zM59 22.5c0-.83-.67-1.5-1.5-1.5h-19c-.83 0-1.5.67-1.5 1.5v12c0 .83.67 1.5 1.5 1.5H41v4.5a1.5 1.5 0 002.56 1.06L49.12 36h8.38c.83 0 1.5-.67 1.5-1.5v-12zM40 24h16v9h-8.12L44 36.88V33h-4v-9z"
                                opacity=".35"></path>
                        </svg>
        ...
        <div class="container">
            <div class="testimonial-carousel owl-carousel owl-theme owl-action-styled">
                <div class="carousel-card text-center">
                    <p class="section-desc w-75 mx-auto">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Autem
                        culpa deserunt dolor ea iure iusto magnam minima, recusandae sequi sunt? Corporis delectus
                        deserunt dicta exercitationem ipsum, iusto magnam minus molestias numquam perspiciatis porro
                        provident quae rem. Placeat saepe, sed. Vitae?</p>
                ...
                <div class="col-lg-5">
                    <div class="info-box text-center">
                        <div class="icon-element icon-element-lg mb-4 shadow-sm mx-auto">
                            <svg class="svg-icon-color-1" width="42" version="1.1" xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="container">
            ...
            <div class="row pt-50px">
                <div class="col-lg-3 responsive-column-half">
                    <div class="info-box px-2">
                        <div class="icon-element icon-element-lg mb-4 shadow-sm">
                            <svg class="svg-icon-color-1" width="40" viewbox="0 -25 424 424"
                ...
                <div class="col-lg-3 responsive-column-half">
                    <div class="info-box px-2">
                        <div class="icon-element icon-element-lg mb-4 shadow-sm">
                            <svg class="svg-icon-color-2" width="40" viewbox="0 0 569 569.54905"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                ...
                <div class="col-lg-3 responsive-column-half">
                    <div class="info-box px-2">
                        <div class="icon-element icon-element-lg mb-4 shadow-sm">
                            <svg class="svg-icon-color-4" width="40" viewbox="-26 0 512 512.001"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-7 py-4">
                    <h2 class="section-title fs-30 lh-40">Build a private community to share technical or non-technical
                        knowledge</h2>
                </div>
                <div class="col-lg-5 text-right">
                    <a href="free-demo.html" class="btn theme-btn">Create a free team <i
                            class="la la-arrow-right icon ml-1"></i></a>
                </div>
            </div>
        </div><!-- end container -->
    ...
    <div class="modal-content">
      ...
      <div class="user-panel">
                                <div class="bg-gray p-3 rounded-rounded">
                                    <h3 class="fs-17">Create a Brand</h3>
                                </div>
                                <form method="post" action="">
                                    <div class="settings-item mb-10px">
                                        <div class="row pt-4 align-items-center">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="input-box">
                                                    <label class="fs-13 text-black lh-20 fw-medium">Brand Name (required)</label>
                                                    <div class="form-group">
                                                        <input class="form-control form--control" type="text" name="brandName">
                                                        <small>Use the name of your business, brand or organisation, or a name that explains what the brand is about.</small>

                                                    </div>
                                                </div>
                                                <div class="input-box">
                                                    <label class="fs-13 text-black lh-20 fw-medium">Category (required)</label>
                                                    <div class="form-group">
                                                    <select class="form-control form--control" name="category">
                                                        <option value="business">Business</option>
                                                    </select>
                                                    <small>Choose a category that describes what type of business, organisation or topic the brnad represents.</small>
                                                    </div>
                                                </div>
                                            </div><!-- end col-lg-6 -->
                                            <div class="col-lg-12">
                                                <div class="input-box">
                                                    ...
                                                    <div class="form-group">
                                                        <textarea class="form-control form--control user-text-editor" name="aboutMe" rows="5"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div><!-- end row -->
                                    ...
                                    <div class="settings-item">
                                        ...
                                        <div class="row pt-4">
                                            <div class="col-lg-12">
                                            <small>You can add images, contact info and other details after you create the brand.</small>

                                                <div class="submit-btn-box pt-3">
                                                
                                                    <button class="btn theme-btn theme-btn-sm " type="submit" name="createBrand">Create</button>
                                                    <button type="button" class="btn theme-btn theme-btn-outline theme-btn-sm  theme-btn-outline-gray" data-dismiss="modal">Close</button>
