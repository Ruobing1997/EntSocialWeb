...
<section class="login-area pt-80px pb-80px position-relative">
    ...
    <div class="container">
        <form action="" method="POST" class="card card-item login-form">
                    ...
                    <div class="form-action-wrapper py-5">
                        <div class="form-group">
                            ...
                            <?php 
                                if(!empty($errorMessage)){
                                    ?>
                                    <p class="pt-3"><?php echo $errorMessage; ?></p>
                                    <?php
                                }
                            ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control form--control"
                                        name="loginId" required="" placeholder="Email address"
                                        value="<?php if(isset($_COOKIE["loginId"])) { echo $_COOKIE["loginId"]; } ?>">
                        </div><!-- end form-group -->
                        <div class="form-group">
                            <label class="fs-14 text-black fw-medium lh-18">Password</label>
                            <div class="input-group">
                                <input type="password" class="form-control form--control password-field" id="password"
                                        name="loginPass" required="" placeholder="Password"
                                        value="<?php if(isset($_COOKIE["loginPass"])) { echo $_COOKIE["loginPass"]; } ?>">
                                <div class="input-group-append">
                                    <button class="btn theme-btn-outline theme-btn-outline-gray toggle-password" type="button">
                                        <svg class="eye-on" xmlns="http://www.w3.org/2000/svg" height="22px" viewbox="0 0 24 24" width="22px" fill="#a1a1a1"><path d="M0 0h24v24H0V0z" fill="none"></path><path d="M12 6c3.79 0 7.17 2.13 8.82 5.5C19.17 14.87 15.79 17 12 17s-7.17-2.13-8.82-5.5C4.83 8.13 8.21 6 12 6m0-2C7 4 2.73 7.11 1 11.5 2.73 15.89 7 19 12 19s9.27-3.11 11-7.5C21.27 7.11 17 4 12 4zm0 5c1.38 0 2.5 1.12 2.5 2.5S13.38 14 12 14s-2.5-1.12-2.5-2.5S10.62 9 12 9m0-2c-2.48 0-4.5 2.02-4.5 4.5S9.52 16 12 16s4.5-2.02 4.5-4.5S14.48 7 12 7z"></path></svg>
                        ...
                        <div class="form-group d-flex align-items-center justify-content-between">
                            ...
                            <input class="custom-control-input" type="checkbox" name="remember"
                                                id="rememberMe" <?php if(isset($_COOKIE["loginId"])) { ?> checked
                                                <?php } ?>>
                                <label class="custom-control-label custom--control-label" for="rememberMe">Remember me!</label>
                            </div>
                            <a href="recover-password.php" class="btn-text fs-14 hover-underline fw-regular">Forgot Password?</a>
                        </div><!-- end form-group -->
                        <div class="form-group">
                            <button id="send-message-btn" class="btn theme-btn w-100" name="login" type="submit">Log in <i class="la la-arrow-right icon ml-1"></i></button>
                        </div><!-- end form-group -->
        ...
        <p class="text-black text-center fs-15">Don't have an account? <a href="signup.php" class="text-color hover-underline">Sign up</a></p>
    </div><!-- end container -->
</section>
<!--======================================
        END LOGIN AREA
