<?php
    ...
    if(isset($_POST['post'])){
        ...
        if(isset($_FILES['File']['name'])){
            ...
            $destination1 = 'attachments/' . $fileName;
        ...
        $sqlQuery = "INSERT INTO posts (userId, title, tags, details, file, date) 
                  VALUES ('".$_SESSION["Userid"]."', '".$_POST['title']."', '".$_POST['tags']."', '".$_POST['details']."', '".$fileName."', '".$date."')";
...
<section class="hero-area pattern-bg-2 bg-white shadow-sm overflow-hidden">
    ...
    <div class="container">
        <div class="hero-content pt-80px pb-80px">
            <h2 class="section-title">Submit Post</h2>
                    ...
                    <form method="post" action="" enctype="multipart/form-data">
                        <div class="input-box">
                            ...
                            <div class="form-group">
                                <input class="form-control form--control fs-13" type="text" name="title" required placeholder="e.g. Is there an R function for finding the index of an element in a vector?">
                            </div>
                        </div><!-- end input-box -->
                        <div class="input-box">
                            ...
                            <div class="form-group">
                                <input class="form-control form--control fs-14 tags-input" type="text" name="tags" required  data-role="tagsinput">
                            </div>
                        </div><!-- end input-box -->
                        <!-- <div class="input-box">
                            ...
                            <div class="form-group select-container-wrap">
                        ...
                        <div class="input-box">
                            ...
                            <div class="form-group">
                                <textarea class="form-control form--control user-text-editor" name="details" required rows="10" cols="40"></textarea>
                            </div>
                        </div><!-- end input-box -->
                        <div class="input-box">
                            <div class="d-flex align-items-center justify-content-between">
                                <div>
                                    <label class="fs-14 text-black fw-medium mb-0">Attachments </label>
                                    <p class="fs-13 pb-3 lh-20">Add attachments related to upgrade:</p>
                                </div>
       
                            </div>
                            <div class="form-group">
                                <input class="form-control form--control fs-14 " type="file" name="File">
                            </div>
                        </div><!-- end input-box -->
                        <div class="input-box pt-2">
                            <div class="form-group">
                                ...
                                <div class="custom-control custom-checkbox fs-13">
                                    <input type="checkbox" class="custom-control-input" id="youAgreeCheckBox" required>
                                    <label class="custom-control-label custom--control-label" for="youAgreeCheckBox">By posting, you agree to the <a href="privacy-policy.html" class="text-color hover-underline">Privacy Policy.</a></label>
                                </div>
                            </div>
                            <div class="btn-box">
                                <button type="submit" name="post" class="btn theme-btn">Publish your Post</button>
                            </div>
                        </div>
                    </form>
                </div><!-- end card -->
