            ...
            <div class="card-body row p-0">
                <div class="col-lg-6">
                    <div class="form-content py-4 pr-60px pl-60px border-right border-right-gray h-100 d-flex align-items-center justify-content-center">
                        <img src="images\undraw-forgot-password.svg" alt="Image" class="img-fluid">
                    </div>
                </div><!-- end col-lg-6 -->
                    ...
                    <div class="form-action-wrapper py-5">
                        <div class="form-group">
                            ...
                            <?php 
                                if(!empty($message)){
                                    ?>
                                    <p class="pt-3"><?php echo $message; ?></p>
                                    <?php
                                }
                            ?>
                            <p class="pt-3">Forgot your account's password or having trouble logging into your Account? Don't worry, we'll help you to get back your account. Enter your email address and we'll send you a temprary password.</p>
                        </div>
                        <div class="form-group">
                            <label class="fs-14 text-black fw-medium lh-18">Email</label>
                            <input type="email" name="loginId" class="form-control form--control" placeholder="Email address">
                        </div><!-- end form-group -->
                        <div class="form-group">
                            <button id="send-message-btn" name="forgetpassword" class="btn theme-btn w-100" type="submit">Send temporary password <i class="la la-arrow-right icon ml-1"></i></button>
                        </div><!-- end form-group -->
                    </div><!-- end form-action-wrapper -->
                </div><!-- end col-lg-5 -->
            </div><!-- end row -->
        </form>
        <p class="text-center"><a href="login.html" class="text-color hover-underline">Return to log in</a></p>
    </div><!-- end container -->
