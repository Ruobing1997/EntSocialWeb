...
<section class="sign-up-area pt-80px pb-80px position-relative">
    <div class="container">
        <form action="" method="POST" class="card card-item">
                    ...
                    <div class="form-action-wrapper py-5">
                        <div class="form-group">
                            ...
                            <?php 
                                if(!empty($errorMessage)){
                                    ?>
                                    <p class="pt-3 text-danger"><?php echo $errorMessage; ?></p>
                                    <?php
                                }
                            ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group mb-1">
                                <input class="form-control form--control password-field" type="password" name="passwd"
                            ...
                            <p class="fs-13 lh-18">Passwords must contain at least eight characters, including at least
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group mb-1">
                                <input class="form-control form--control password-field" type="password" name="cpasswd"
                        ...
                        <div class="form-group">
                            <div class="d-flex align-items-center">
                                <div class="custom-control custom-checkbox fs-13 mr-4">
                                    <input type="checkbox" class="custom-control-input" id="opt-in" required>
                                ...
                                <div class="generic-popover d-none">
                                    <p class="pb-2 fs-14">We know you hate spam, and we do too. That’s why we make it
                                        easy for you to update your email preferences or unsubscribe at anytime.</p>
                                    <p class="fs-14">We never share your email address with third parties for marketing
                                        purposes.</p>
                                </div><!-- end generic-popover -->
                            </div>
                        </div><!-- end form-group -->
                        <div class="form-group">
                            <button id="send-message-btn" class="btn theme-btn w-100" type="submit" name="register">Sign up <i
                                    class="la la-arrow-right icon ml-1"></i></button>
                        </div><!-- end form-group -->
                        <p class="fs-13 lh-18 pb-3">By clicking “Sign up”, you agree to our <a
                                href="terms-and-conditions.php" class="text-color hover-underline">terms of
                                conditions</a>, <a href="privacy-policy.php" class="text-color hover-underline">privacy
                                policy</a></p>
                        <!-- <div class="social-icon-box">
                            <div class="pb-3 d-flex align-items-center">
                                <hr class="flex-grow-1 border-top-gray"><span
                                    class="mx-2 text-gray-2 fw-medium text-uppercase fs-14">or</span>
                                <hr class="flex-grow-1 border-top-gray">
                            </div>
                            <button
                                class="btn theme-btn google-btn d-flex align-items-center justify-content-center w-100 mb-2"
                                type="button">
                                <span class="btn-icon"><svg focusable="false" width="16px" height="16px"
                            ...
                            <button
                                class="btn theme-btn facebook-btn d-flex align-items-center justify-content-center w-100 mb-2"
                                type="button">
                                <span class="btn-icon"><svg focusable="false" width="16px" height="16px"
                            ...
                            <button
                                class="btn theme-btn twitter-btn d-flex align-items-center justify-content-center w-100"
                                type="button">
                                <span class="btn-icon"><svg focusable="false" width="16px" height="16px"
        ...
        <p class="text-black text-center fs-15">Already have an account? <a href="login.php"
